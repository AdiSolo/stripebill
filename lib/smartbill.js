...
async function createSmartBillInvoice(paymentId, retryAttempt = 0) {
  try {
...
async function getSmartBillInvoiceDownloadUrl(invoiceLinkId) {
  try {
...
module.exports = {
  ...
  getSmartBillInvoiceDownloadUrl
};
